...
namespace utils
{
    ...
    */
    ...
    private:
        ...
        */
        void transfromVector(const std::vector<std::vector<float>> &input, std::vector<std::vector<float>> &rslt);
        /**
         * Helper function of converting DCT wave into raw data.
         * @param input DCT data input.
         * @param rslt Raw data output.
        */
        void itransfromVector(const std::vector<std::vector<float>> &input, std::vector<std::vector<float>> &rslt);
        /**
